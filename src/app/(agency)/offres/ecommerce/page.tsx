          ...
          <Reveal>
            <div className="max-w-text">
              ...
              <p className="text-lead text-ink-2 font-light mb-8">
                Si vous vendez en ligne, le travail sur le flux produit et sur
                la valeur de conversion s&apos;ajoute au pilotage mensuel. Ce
                module n&apos;existe pas seul : il vient compléter la gestion du
                compte, pas la remplacer.
              </p>
              <Link
          ...
          <ol className="border-t border-line-strong">
            {WORK.map((w, i) => (
              <Reveal
                ...
                key={w.t}
                delay={i * 70}
                className="grid grid-cols-1 md:grid-cols-[64px_1fr] gap-3 md:gap-8 py-6 border-b border-line-strong"
              >
                ...
                <div>
                  ...
                  <p className="text-body text-ink-2 font-light max-w-[68ch]">
                    {w.d}
                  </p>
                </div>
              </Reveal>
      ...
      <section className="bg-eclat">
        <div className="container-text py-14 md:py-20 text-center">
          ...
          <p className="text-lead text-white font-light mb-8">
            Gratuit, écrit, sous 48 h ouvrées : état du flux produit, structure
            Shopping et Performance Max, fiabilité de la valeur de conversion.
          </p>
