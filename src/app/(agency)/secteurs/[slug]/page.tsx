  ...
  return (
    <>
      ...
      <section className="section">
        <div className="container-wide">
          <Reveal>
            ...
            <h1 className="text-display font-semibold text-ink mb-5 max-w-[20ch]">
              {s.h1}
            </h1>
        ...
        <div className="container-wide max-w-[76ch]">
          <Reveal>
            <div className="flex items-start gap-3 mb-4">
              <Target
                size={22}
                className="text-eclat-ink mt-1 shrink-0"
                aria-hidden="true"
              />
        ...
        <div className="container-wide">
          <Reveal>
            ...
            <p className="text-body text-ink-3 font-light mb-7 max-w-[62ch]">
              La liste importe moins que la raison : c&apos;est elle qui vous
              permet de juger si l&apos;exclusion s&apos;applique à votre cas.
            </p>
          </Reveal>
            ...
            {s.negatives.map((n, i) => (
              <Reveal key={n.term} delay={i * 60}>
                <div className="bg-white border border-line rounded-card p-5 h-full">
                  <div className="font-mono text-caption text-eclat-ink mb-2">
                    {n.term}
                  </div>
      ...
      <section className="section">
        <div className="container-wide">
          <Reveal>
            <h2 className="text-section font-semibold text-ink mb-7">
          ...
          <ul className="flex flex-col gap-4 max-w-[72ch] list-none p-0 m-0">
            {s.angles.map((a, i) => (
              ...
              >
                <ArrowRight
                  size={17}
                  className="text-eclat-ink mt-1.5 shrink-0"
                  aria-hidden="true"
                />
        ...
        <div className="container-wide text-center">
          <Reveal>
            ...
            <p className="text-body-lg text-ink-2 font-light mb-7 max-w-[54ch] mx-auto">
              L&apos;audit est gratuit et vous repartez avec, que l&apos;on
              travaille ensemble ou non. Aucun chiffre de performance ne vous
              sera promis avant que j&apos;aie vu votre compte.
            </p>
            <Link
              href="/audit"
