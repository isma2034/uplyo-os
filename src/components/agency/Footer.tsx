...
const COLUMNS: {
...
}[] = [
  {
    ...
    links: [
      ...
      {
        label: OFFER_ROUTES.ecommerce.label,
  ...
  {
    title: "Questions",
    links: [{ label: "Toutes les questions", href: "/questions" }],
  },
  {
    title: "Uplyo",
    links: [
  ...
  },
  {
    ...
    links: [
      {
        label: SITE_CONFIG.contactEmail,
    ...
    <footer className="bg-nuit border-t-2 border-eclat">
      <div className="container-wide pt-12 md:pt-16 pb-8">
        {/* La marque est sortie de la grille de liens : le gabarit precedent
            ...
            desormais toutes seules, quel que soit le contenu de COLUMNS. */}
